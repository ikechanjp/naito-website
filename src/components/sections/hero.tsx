        ...
        <div className="text-center space-y-8 max-w-4xl w-full">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
              ...
              />
              <br />
              <span className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl">パパママに<span className="bg-gradient-to-r from-blue-400 to-pink-400 bg-clip-text text-transparent">「時短」</span>と<span className="bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent">「収益」</span>を</span>
            </h1>
